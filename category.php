...
<section class="p-category">
   ...
   <a href="category.php?category=fruits" class="cat-box">
      
      <span>fruits</span>
   </a>

   <a href="category.php?category=vegetables" class="cat-box">
      
      <span>vegetables</span>
   </a>

   <a href="category.php?category=fish" class="cat-box">
      
      <span>fish</span>
   </a>

   <a href="category.php?category=meat" class="cat-box">
...
<section class="products">
   ...
   <?php
   if(!empty($category)){
   $select_products = $conn->prepare("SELECT * FROM products WHERE LOWER(category) = LOWER(?)");
