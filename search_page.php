...
<section class="search-form">
   <!-- Ang "value" attribute magpabilin sa imong gi-type maski mo-refresh ang page -->
   <form action="" method="POST">
      <input type="text" class="box" name="search_box" placeholder="Search products..." value="<?= isset($_POST['search_box']) ? $_POST['search_box'] : ''; ?>" required>
...
<section class="products" style="padding-top: 0; min-height:100vh;">
   ...
   <?php
      if(isset($_POST['search_btn']) || isset($_POST['search_box'])){
         ...
         // Search gamit ang Name o Category
