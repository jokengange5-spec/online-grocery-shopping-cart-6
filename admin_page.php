...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>🔥</h3>
         <p>Top Product</p>
         <span style="display:block; margin:10px 0; color:#00f260; font-weight:bold; font-size: 13px;">
            <?= (strlen($top_product) > 50) ? substr($top_product,0,50).'...' : $top_product; ?>
         </span>
         <a href="admin_orders.php" class="btn">Analyze</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Admins</p>
         <a href="admin_users.php" class="btn">View Admins</a>
      </div>
...
<script>
   // Logic para sa header profile toggle kung naa man sa admin_header.php
