...
<section class="wishlist">
   ...
   <?php
      $grand_total = 0;$select_wishlist = 
      $conn->prepare("SELECT * FROM wishlist WHERE user_id = ?");
...
$select_wishlist->execute([$user_id]);
   ...
   <div class="wishlist-total">
      ...
      <a href="shop.php" class="option-btn">continue shopping\n</a>
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>">Remove Products</a>
   </div>
